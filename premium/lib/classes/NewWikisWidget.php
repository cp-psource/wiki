...
class NewWikisWidget extends WP_Widget {
		function __construct() {
			...
			$widget_ops = array( 'description' => __('Neue Wiki-Seiten anzeigen', 'ps-wiki') );
			$control_ops = array( 'title' => __('Neue Wikis', 'wiki'), 'hierarchical' => 'yes' );

			parent::__construct( 'psource_new_wikis', __('Neue Wikis', 'ps-wiki'), $widget_ops, $control_ops );
		}
		...
		function update($new_instance, $old_instance) {
			...
			$new_instance = wp_parse_args( (array) $new_instance, array( 'title' => __('Neue Wikis', 'ps-wiki'), 'hierarchical' => 'yes') );
		...
		$instance = wp_parse_args( (array) $instance, array( 'title' => __('Neue Wikis', 'ps-wiki'), 'hierarchical' => 'yes'));
