...
class PopularWikisWidget extends WP_Widget {
    ...
    function __construct() {
    	...
    	global $wiki;
			...
			$widget_ops = array( 'description' => __('Beliebte Wiki-Seiten anzeigen', 'wiki') );
    ...
    function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Beliebte Wikis', 'wiki') : $instance['title'], $instance, $this->id_base);
    ...
    function update($new_instance, $old_instance) {
      ...
      $new_instance = wp_parse_args( (array) $new_instance, array( 'title' => __('Beliebte Wikis', 'wiki'), 'hierarchical' => 'yes') );
    ...
    function form($instance) {
    	...
    	global $wiki;
			...
			$instance = wp_parse_args( (array) $instance, array( 'title' => __('Beliebte Wikis', 'wiki'), 'hierarchical' => 'yes'));
		...
		<div style="text-align:left">
			...
			<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo $options['title']; ?>" type="text" style="width:95%;" />
				...
				<label for="<?php echo $this->get_field_id('hierarchical'); ?>" style="line-height:35px;display:block;"><?php _e('Ebenen', 'wiki'); ?>:<br />
