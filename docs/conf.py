...
# of the sidebar.
html_logo = "padma_sphinx_theme/static/images/padma-logo-dark.svg"
...
htmlhelp_basename = 'PadmaSphinxthemedemodoc'
...
man_pages = [
    ('index', 'padmathemedemo', u'Padma theme demo Documentation',
     [u'Padma'], 1)
]
