...
class PopularWikisWidget extends WP_Widget {
    function __construct() {
		...
		$widget_ops = array( 'description' => __('Beliebte Wiki-Seiten anzeigen', 'ps-wiki') );
      	$control_ops = array( 'title' => __('Beliebte Wikis', 'ps-wiki'), 'hierarchical' => 'yes' );
		//parent::WP_Widget( 'psource_popular_wikis', __('Beliebte Wikis', 'wiki'), $widget_ops, $control_ops );
		parent::__construct( 'psource_popular_wikis', __('Beliebte Wikis', 'ps-wiki'), $widget_ops, $control_ops );
    }
    ...
    function widget($args, $instance) {
		...
		$options = $instance;
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Beliebte Wikis', 'ps-wiki') : $instance['title'], $instance, $this->id_base);
    ...
    function update($new_instance, $old_instance) {
		...
		$instance = $old_instance;
      	$new_instance = wp_parse_args( (array) $new_instance, array( 'title' => __('Beliebte Wikis', 'ps-wiki'), 'hierarchical' => 'yes') );
    ...
    function form($instance) {
    	global $wiki;
			...
			$instance = wp_parse_args( (array) $instance, array( 'title' => __('Beliebte Wikis', 'ps-wiki'), 'hierarchical' => 'yes'));
