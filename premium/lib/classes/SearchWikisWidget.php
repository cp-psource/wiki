...
class SearchWikisWidget extends WP_Widget {
    ...
    function __construct() {
			...
			$widget_ops = array( 'description' => __('Wiki-Seiten durchsuchen', 'wiki') );
	...
	$title = apply_filters('widget_title', empty($instance['title']) ? __('Suche Wikis', 'wiki') : $instance['title'], $instance, $this->id_base);		   		 		  	   			
	...
	$instance = $old_instance;
        ...
        $new_instance = wp_parse_args( (array) $new_instance, array( 'title' => __('Suche Wikis', 'wiki')) );
	...
	$instance = wp_parse_args( (array) $instance, array( 'title' => __('Suche Wikis', 'wiki')));
