...
class NewWikisWidget extends WP_Widget {
		...
		function __construct() {
			...
			$widget_ops = array( 'description' => __('Neue Wiki-Seiten anzeigen', 'wiki') );
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Neue Wikis', 'wiki') : $instance['title'], $instance, $this->id_base);
		...
		function update($new_instance, $old_instance) {
			...
			$new_instance = wp_parse_args( (array) $new_instance, array( 'title' => __('Neue Wikis', 'wiki'), 'hierarchical' => 'yes') );
		...
		$instance = wp_parse_args( (array) $instance, array( 'title' => __('Neue Wikis', 'wiki'), 'hierarchical' => 'yes'));
